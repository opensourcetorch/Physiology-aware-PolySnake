...
crop_scale = np.array([96, 96])
input_scale = np.array([96, 96])
...
def augment(img, split, _data_rng, _eig_val, _eig_vec, mean, std, polys):
    ...
    # print("bf input_w, input_h:", input_w, "and", input_h)
    if split != 'train':
    ...
    # print("input_w, input_h:", input_w,"and", input_h)
    trans_input = data_utils.get_affine_transform(center, scale, 0, [input_w, input_h])
    inp = cv2.warpAffine(img, trans_input, (input_w, input_h), flags=cv2.INTER_LINEAR)
    # print("aug_inp_shape:",inp.shape)
    # bfinput_w, input_h: 96 and 96
    # input_w, input_h: 96 and 96
    # aug_inp_shape: (96, 96, 15)
    # input_shape: (15, 96, 96)
    # img_shape: (96, 96, 15)
    ...
    # print("affine:center, scale, 0, [output_w, output_h]:",center, scale, 0, [output_w, output_h])
