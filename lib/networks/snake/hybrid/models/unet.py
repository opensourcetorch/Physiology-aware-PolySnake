...
from volume.models.utils import _initialize_weights
...
def UNet18(in_channels, out_channels):
    return UNet(in_channels=in_channels, out_channels=out_channels, down_blocks=[16, 32, 64],
                 up_blocks = [64, 32, 16], bottleneck = 128)
