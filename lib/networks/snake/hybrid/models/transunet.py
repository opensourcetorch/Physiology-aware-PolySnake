...
class Decoder(nn.Module):
    def __init__(self, out_channels, class_num):
        ...
        self.decoder4 = DecoderBottleneck(int(out_channels * 1 / 2), int(64))

        self.conv1 = nn.Conv2d(int(64), class_num, kernel_size=1)
...
class TransUNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x,feature = self.decoder(x, x1, x2, x3)

        return x,feature


def TransUnet(img_dim=96,
              in_channels=1,
              out_channels=128,
              head_num=4,
              mlp_dim=512,
              ...
              patch_dim=16,
              class_num=3):
    return TransUNet(img_dim=img_dim,
