...
import time
from .transforms import CentralCrop, RandomCentralCrop, HU2Gray, RandomRotation, RandomFlip, Rescale, Gray2InnerOuterBound, ToTensor
from torchvision import transforms
from vision import sample_stack_color
import os
...
#                 sample_stack_color(image_np[0], rows=10, cols=10, start_with=0, show_every=2, scale=4, fig_name=image_name)
#                 sample_stack_color(mask_np[0], rows=10, cols=10, start_with=0, show_every=2, scale=4, fig_name=mask_name)
#
